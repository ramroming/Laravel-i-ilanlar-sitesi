    ...
    <div class="container-fluid row align-items-center justify-content-center ">
        ...
        <!-- Sales Cards  -->
        <!-- ============================================================== -->
        <div class="row bg-light p-5 m-auto">
            <h1 class="text-center text-black"> Welcome To Admin Panel! </h1>

            <p  style='font-size:20px;' class="text-center text-black">Check what you can do from the side-bar !<span>&#128513;</span></p>
{{--            <!-- Column -->--}}
